...
class ApproveBankDepositsController extends Controller
{
    public function index($route = null){
        ...
        if($countCheckThisRoutes == 0){
            ...
            return view('pages.dashboard.payonline.approvebankdeposits', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions'));
        }
    }
}
