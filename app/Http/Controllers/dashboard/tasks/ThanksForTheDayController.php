...
class ThanksForTheDayController extends Controller
{
    public function index($route = null){
        ...
        return view('pages.dashboard.tasks.tasksfortheday', compact('mainMenus', 'data','subsMenus', 'parentid','mainRouteName','routesPermissions'));
    }
}
