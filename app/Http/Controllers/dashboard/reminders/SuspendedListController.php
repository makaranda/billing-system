...
class SuspendedListController extends Controller
{
    public function index($route = null){
        ...
        return view('pages.dashboard.reminders.suspendedlist', compact('mainMenus', 'data','subsMenus', 'parentid','mainRouteName','routesPermissions'));
    }
}
