...
class FiscalReceiptsController extends Controller
{
    public function index($route = null){
        ...
        return view('pages.dashboard.reminders.fiscalreceipts', compact('mainMenus', 'data','subsMenus', 'parentid','mainRouteName','routesPermissions'));
    }
}
