...
class AllocateCustomerController extends Controller
{
    public function index($route = null){
        ...
        if($countCheckThisRoutes == 0){
            ...
            return view('pages.dashboard.reminders.allocatecustomerreceipt', compact('mainMenus', 'data','subsMenus', 'parentid','mainRouteName','routesPermissions'));
        }
    }
}
