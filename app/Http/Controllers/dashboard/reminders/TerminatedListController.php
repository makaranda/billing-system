...
class TerminatedListController extends Controller
{
    public function index($route = null){
        ...
        return view('pages.dashboard.reminders.terminatedlist', compact('mainMenus', 'data','subsMenus', 'parentid','mainRouteName','routesPermissions'));
    }
}
