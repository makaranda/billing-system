...
class QuotationFormatsController extends Controller
{
    public function index($route = null){
        ...
        if($countCheckThisRoutes == 0){
            ...
            return view('pages.dashboard.documents.quotationformats', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions'));
        }
    }
}
