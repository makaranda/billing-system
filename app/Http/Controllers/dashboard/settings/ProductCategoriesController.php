...
class ProductCategoriesController extends Controller
{
    public function index($route = null){
        ...
        //dd($mainMenus);
        return view('pages.dashboard.settings.productcategories', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions','getAllRoutePermisssions'));
    }
}
