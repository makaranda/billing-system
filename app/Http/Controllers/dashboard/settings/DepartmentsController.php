...
class DepartmentsController extends Controller
{
    public function index($route = null){
        ...
        //dd($mainMenus);
        return view('pages.dashboard.settings.departments', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions','getAllRoutePermisssions'));
    }
}
