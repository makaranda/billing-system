...
class TaxController extends Controller
{
    public function index($route = null){
        ...
        //dd($mainMenus);
        return view('pages.dashboard.settings.tax', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions','getAllRoutePermisssions'));
    }
}
