...
class CurrencyExchangeSettingsController extends Controller
{
    public function index($route = null){
        ...
        //dd($mainMenus);
        return view('pages.dashboard.settings.currencyexchangesettings', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions'));
    }
}
