...
class FiscalReceiptUploadController extends Controller
{
    public function index($route = null){
        ...
        if($countCheckThisRoutes == 0){
            ...
            return view('pages.dashboard.customers.fiscalizereceipt', compact('mainMenus','subsMenus', 'data','mainRouteName', 'remindersRoute', 'parentid','routesPermissions','getAllRoutePermisssions','routepermissions','getAllCustomers'));
        }
    }

    public function updateFiscalReceipt(Request $request,$pro_id){
        $messageType = '';
        $message = '';
    ...
    public function fetchFiscalReceipts(Request $request){
