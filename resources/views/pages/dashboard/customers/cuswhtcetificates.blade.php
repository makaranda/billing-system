                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-md-12">
                            <div class="row">
                                <div class="col-12">
                                     <h1 class="text-uppercase">WHT Cetificates</h1>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <span class="text-uppercase">Withholding Tax Deduction Cetificates - Attachments</span>
                                        </div>
...
@push('scripts')
    ...
    $('#frm_add_attachments').on('submit', function(event){
        ...
        if($('#form_type').val() == 'cuswhtcetificates.editwhtcetificate'){
            form_type = '{{ route("cuswhtcetificates.updatewhtcetificate", ":id") }}';
            form_type = form_type.replace(':id', receipt_id);
        }else{
            form_type = '{{ route("cuswhtcetificates.addwhtcetificate") }}';
        }
    ...
    function listTableDatas(page=1,from_date=null, to_date=null, customer_id=null, receipt_no=null, wht_cert_no=null, type=null) {
        ...
        $('#overlay').show();
        $.ajax({
                url : "{{ route('cuswhtcetificates.fetchwhtcetificates') }}",
                cache: false,
