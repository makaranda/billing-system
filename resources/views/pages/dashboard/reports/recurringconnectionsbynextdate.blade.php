...
<div class="container">
    <div class="page-inner">
      <div class="page-header">
        <h3 class="fw-bold mb-3 text-capitalize">Recurring Connections by next Date</h3>
        <ul class="breadcrumbs mb-3">
          ...
          <li class="nav-item text-capitalize">
            <a href="#">Recurring Connections by next Date</a>
          </li>
        </ul>
      </div>
        @php
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-md-12">
                            <div class="row">
                                <div class="col-12">
                                     <h1 class="text-uppercase">Recurring Connections by next Date</h1>
